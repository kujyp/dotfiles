...
function install_android_components() {
    ...
    install_android_component_with_sdkmanager "system-images;android-28;google_apis_playstore;x86_64"
    ...
    install_android_component_with_sdkmanager "system-images;android-23;google_apis;x86"
